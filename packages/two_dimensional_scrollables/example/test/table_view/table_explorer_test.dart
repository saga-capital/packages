...
import 'package:two_dimensional_examples/table_view/pinned_table.dart';
...
void main() {
  testWidgets('Table explorer switches between samples', (
    ...
    expect(find.byType(PinnedTableExample), findsNothing);
    expect(find.byType(Radio<TableType>), findsNWidgets(4));
    ...
    expect(find.byType(MergedTableExample), findsNothing);
    expect(find.byType(InfiniteTableExample), findsNothing);
    expect(find.byType(PinnedTableExample), findsOneWidget);
